                    	...
                    	<form action="{{route('checkout.put')}}" class="col-md-12" id="checkout-infor-form" method="POST">
                            ...
                            <div class="col-md-12 form-group">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="email" class="form-control" name="email" placeholder="Nhập địa chỉ Email" value="{{$email}}" {{Auth::check()?'readonly':''}} />
                                    @if($errors->has('email'))
                                        <div class="col-md-12 alert alert-danger">
                            ...
                            <div class="col-md-12 form-group">
                                <div class="checkout-form-list">
                                    ...
                                    <input type="text" class="form-control" name="phone" placeholder="Nhập số điện thoại của bạn" value="{{$phone}}"/>
                                    @if($errors->has('phone'))
                                        <div class="col-md-12 alert alert-danger">
